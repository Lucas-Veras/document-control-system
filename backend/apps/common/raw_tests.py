...
def sign(
    ...
    sigField = SignatureWidget.Create(
        doc, Rect(x_coordinate, y_coordinate, x_coordinate + 100, y_coordinate + 50), signatureID
    )
...
def parse_args():
    ...
    parser.add_argument("-s", "--signatureID", dest="signatureID", type=str, help="Enter the ID of the signature")
    parser.add_argument("-p", "--pages", dest="pages", type=tuple, help="Enter the pages to consider e.g.: [1,3]")
